package demo.free.com.demoapp.Login;// Created by $USER_NAME on 22-08-2016.
...
public class LoginActivity extends AppCompatActivity {
    ...
    private void sendRequest() {
        if (edt_email.getText().toString().trim().equalsIgnoreCase("") || edt_pass.getText().toString().trim().equalsIgnoreCase("")) {
            Toast.makeText(LoginActivity.this, "Plz fill all the fields", Toast.LENGTH_LONG).show();

        } else {
            String URL = "http://172.31.98.126/project/demo/public/index.php";
            Log.d("REG URL", "" + URL);
            myprogress = new MyProgress(LoginActivity.this, "Loading..");
            ...
            JsonObjectRequest register_req = new JsonObjectRequest(Request.Method.POST, URL, null, new Response.Listener<JSONObject>() {
                ...
                public void onErrorResponse(VolleyError error) {
                    ...
                    if (error instanceof NetworkError) {
                        ...
                        Toast.makeText(LoginActivity.this, "ServerError", Toast.LENGTH_LONG).show();
                    } else if (error instanceof AuthFailureError) {
                    } else if (error instanceof ParseError) {
                    } else if (error instanceof NoConnectionError) {
                        Toast.makeText(LoginActivity.this, "NoConnectionError", Toast.LENGTH_LONG).show();
                    } else if (error instanceof TimeoutError) {
                        Toast.makeText(LoginActivity.this, "TimeoutError", Toast.LENGTH_LONG).show();
